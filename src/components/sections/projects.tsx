		...
		<section id="projects" className="max-w-7xl mx-auto md:h-[130vh]">
			...
			{projects.length > 0 ? (
				...
				<div className="flex items-center justify-center">
					<p className="text-center text-neutral-600 dark:text-neutral-500">
						I&apos;m still working on my projects, check back later!
					</p>
				</div>
			)}
		</section>
...
const ModalProject = ({ project }: { project: Project }) => {
	return (
		<div className="flex items-center justify-center">
			<Modal>
