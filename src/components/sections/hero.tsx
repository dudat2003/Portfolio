...
const HeroSection = () => {
	...
	const cvUrl =
		...
		"https://drive.google.com/file/d/1VKj1W8cdkBuJgic1H9bVyQ_Cv-hXzSVR/view?usp=sharing";
	return (
		<section id={sectionId} className={cn("relative w-full h-screen")}>
					...
					{!isLoading && (
						<>
									...
									<Tooltip delayDuration={300}>
										<TooltipTrigger asChild>
											<h1
												...
												style={{
													background:
														"radial-gradient(64.73% 64.84% at 47.87% 39.58%, #FFF 0%, #999 100%)",
							...
							<div className="mt-8 md:ml-2 flex flex-col gap-3">
								<Link href={cvUrl} target="_blank" className="flex-1">
